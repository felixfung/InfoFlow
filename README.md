...
![](https://www.codecogs.com/eqnedit.php?latex==&space;\sum_{\substack{~~~\alpha\in&space;j\\or~\alpha\in&space;k}}&space;~~&space;\sum_{\substack{~~~~\beta\notin&space;j\\and\beta\notin&space;k}}&space;p_\alpha\omega_{\alpha\beta})

![](https://latex.codecogs.com/svg.latex?=&space;\sum_{\substack{\alpha\in&space;j\\\text{or}~\alpha\in&space;k}}&space;~~&space;\sum_{\substack{\beta\notin&space;j\\\text{and}\beta\notin&space;k}}&space;p_\alpha\omega_{\alpha\beta})
